define(['durandal/app'], function (app) {
    var vm = function () {
        ...
        self.adicionarCarrinho = function (item) {
            var tempparaAdicionar = JSON.stringify({ Tipo: 'Produto', Nome: self.displayName, Vendedor: item.Nome, Rating: item.Rating, Preco: item.Preco, Stock: item.Stock, Imagem: self.record().Imagem, Quantidade: 1, Id: self.cookies() });
