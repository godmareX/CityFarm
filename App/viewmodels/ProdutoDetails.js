define(['durandal/app'], function (app) {
    var vm = function () {
        ...
        self.adicionarCarrinho = function (item) {
            var tempparaAdicionar = JSON.stringify({ Nome: self.displayName, Vendedor: item.Nome, Rating: item.Rating, Preco: item.Preco, Stock: item.Stock, Imagem: self.record.Imagem });
